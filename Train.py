...
class Trainer:
    ...
    def Load_Checkpoint(self):
        ...
        message = 'Start training with checkpoint {} steps'.format(self.steps)
    ...
    def Save_Checkpoint(self):
        try:
            ...
            message = 'Checkpoint saved at {} steps.'.format(self.steps)
            os.system(f"python3 send_notification.py '{message}'")
            ...
            message = f'Failed to save a checkpoint at {self.steps}!!!'
            os.system(f"python3 send_notification.py '{message}'")
...
def remove_last_checkpoint():
    try:
        ...
        if len(paths) > 0:
            ...
            message = f'checkpoint removed at {path}'
            os.system(f"python3 send_notification.py '{message}'")
