...
def AIHub_Mediazen(
    ...
    for index, (wav_path, midi_path, genre, singer) in tqdm(
        ...
        is_eval_music = 'eval' in wav_path or 'eval' in midi_path
        print(music_label, 'eval :', is_eval_music)
...
# python3 Pattern_Generator.py -hp Hyper_Parameters.yaml -am ./Datasets/data
